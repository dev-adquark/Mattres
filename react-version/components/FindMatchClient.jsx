...
/**
 * Split out of app/find-match/page.js (a Server Component) so the real
 * brandCount stat can come from the database via a prop, rather than
 * this 'use client' file importing the static JSON snapshot directly
 * (which it can't replace with a live getCatalog() call - that pulls in
 * the server-only Supabase client, which must never ship to the
 * browser bundle).
 */
        ...
        <div className="wrap">
          <div className="fm-layout">
            <div className="fm-side">
              <FindMatchStats brandCount={brandCount} />
            </div>
